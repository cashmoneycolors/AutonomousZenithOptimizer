...
Run `python scripts/compile_python_modules.py --clean` whenever you need to rebuild the Python bytecode.
The script compiles everything into `binary_artifacts/python_modules/` so the tracked `python_modules/__pycache__` files stay untouched and stable.
