...
class ConfigManager:
    ...
    def load_config(self):
        ...
        if not os.path.exists(self.config_file):
            print(f"WARN: Config file {self.config_file} not found, creating default config")
    ...
    def _create_default_config(self):
        ...
        try:
            ...
            print(f"ERROR: Error saving default config: {e}")
...
if __name__ == "__main__":
    ...
    if errors:
        print(f"WARN: Konfigurationsfehler gefunden ({len(errors)}):")
        for error in errors:
            print(f"  - {error}")
    else:
        print("OK: Konfiguration ist gültig")
